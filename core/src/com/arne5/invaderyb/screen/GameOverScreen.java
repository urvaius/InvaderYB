		...
		public void render(SpriteBatch sb)
			{
				...
				sb.draw(sprite, InvaderYB.WIDTH / 2 - sprite.getWidth() / 2, InvaderYB.HEIGHT / 2 - sprite.getHeight() / 2);
				layout.setText(highScoreFont, "HighScore "+ Gdx.app.getPreferences("GamePref").getInteger("HighScore"));

				highScoreFont.draw(sb,layout, 10 , InvaderYB.HEIGHT - highScoreFont.getXHeight() -layout.height*2 );
