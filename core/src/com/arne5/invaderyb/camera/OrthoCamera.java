package com.arne5.invaderyb.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(InvaderYB.WIDTH, InvaderYB.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(InvaderYB.WIDTH, InvaderYB.HEIGHT);
